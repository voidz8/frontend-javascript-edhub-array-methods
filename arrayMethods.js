...
const oldMens = inventors.filter((inventor) => {
...
const birthdays = inventors.map((inventor) => {
...
const sortedOnBday = inventors.sort((a,b) =>
  a.year - b.year
);

console.log(sortedOnBday);
...
const sortedOnAge = inventors.sort((a,b) => {
  return (b.passed - b.year) - (a.passed - a.year);
});

console.log(sortedOnAge);
...
const edisonInventors = inventors.filter((inventor) => {
  return inventor.last === 'Edison';
});

console.log(edisonInventors);